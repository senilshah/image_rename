  ...
  (function(_React$Component) {
    ...
    function UploadList() {
      ...
      _this = _possibleConstructorReturn(
        this,
        _getPrototypeOf(UploadList).apply(this, arguments)
      );
      ...
      _this.handleEdit = function(file, e) {
      ...
      _this.renderUploadList = function(_ref) {
        ...
        var _this$props = _this.props,
          ...
          showEditIcon = _this$props.showEditIcon,
        ...
        var list = items.map(function(file) {
          ...
          var infoUploadingClass = (0, _classnames['default'])(
            ((_classNames = {}),
            _defineProperty(
              _classNames,
          ...
          var previewIcon = showPreviewIcon
          ...
          var removeIcon = showRemoveIcon
            ? React.createElement(_icon['default'], {
                type: 'delete',
                title: locale.removeFile,
                onClick: function onClick(e) {
                  return _this.handleClose(file, e);
                },
              })
            : null;
          ...
          var editIcon =
            showEditIcon && imageTypes.indexOf(extention) > -1
              ? React.createElement(_icon['default'], {
                  type: 'edit',
                  title: locale.editFile,
                  onClick: function onClick(e) {
                    return _this.handleEdit(file, e);
                  },
                })
              : null;

          var removeIconClose = showRemoveIcon
            ? React.createElement(_icon['default'], {
                type: 'close',
                title: locale.removeFile,
          ...
          var iconAndPreview =
            file.status === 'error'
              ...
              : React.createElement('span', null, icon, preview);
        ...
        var listClassNames = (0, _classnames['default'])(
          ((_classNames2 = {}),
          _defineProperty(_classNames2, ''.concat(prefixCls, '-list'), true),
          _defineProperty(
            _classNames2,
